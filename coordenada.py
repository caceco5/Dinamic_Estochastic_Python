...
class Coordenada:
    ...
    def mover(self, delta_x, delta_y):
        # deltas definen cuanto se mueven a cada direccion. regresa una nueva coordenada con la suma de la coordenada actual 
        # + los cambios en delta x cada que generamos un cambio creamos una nueva coordenada, es inmutable. 
